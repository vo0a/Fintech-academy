...
contract DaromCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function DaromCoin() {
        ...
        name = "DaromCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "DR";                                             // Set the symbol for display purposes (CHANGE THIS)
